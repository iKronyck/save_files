...
import {getStoragePermission} from '../../utils/permission';
    ...
    if (storagePermission) {
      if (Platform.OS === 'android') {
        const data = await RNFetchBlob.fs.writeFile(
          `${dirs.PictureDir}/SaveFiles/prueba_2.png`,
          imageBase64,
          'base64',
        );
        await RNFetchBlob.android.addCompleteDownload({
          ...
          path: `${dirs.PictureDir}/SaveFiles/prueba_1.png`,
          showNotification: true,
          title: 'Image downloaded success',
        });
        Alert.alert(
          'Download Success',
        ...
        Share.open({
          url: `data:application/vnd.ms-excel;base64,${imageBase64}`,
        });
      }
    }
  };
